...
juego::juego (int resolucion_x, int resolucion_y, string titulo)
{
	...
	//Tamaño del sprite
	room->setScale(800.f / room->getTexture()->getSize().x, 600.f / room->getTexture()->getSize().y); //formula: dimension deseada dividido el tamaño actual, para cambiar el tamaño del sprite
	...
	//Tamaño del sprite
	sprites1->setScale(50.f / sprites1->getTexture()->getSize().x, 50.f / sprites1->getTexture()->getSize().y); //dimension deseada / el tamaño actual
